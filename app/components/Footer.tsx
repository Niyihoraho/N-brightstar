      ...
      <div className="footer-body-new">
        <div className="footer-grid-new">
          ...
          <div className="footer-brand-col">
            ...
            {/* Social Media Icons in School Colors */}
            <div className="footer-social-icons">
              <span
                className="footer-social-link footer-social-link--blue footer-social-link--disabled"
                aria-label="Facebook"
                title="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/nbrightstaracademy?igsi=NG55eTd2MzlocjB2"
                target="_blank"
                rel="noopener noreferrer"
                className="footer-social-link footer-social-link--yellow"
              ...
              <span
                className="footer-social-link footer-social-link--green footer-social-link--disabled"
                aria-label="WhatsApp"
                title="WhatsApp"
              >
                <svg width={18} height={18} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              ...
              <span
                className="footer-social-link footer-social-link--red footer-social-link--disabled"
                aria-label="YouTube"
                title="YouTube"
              >
                <svg width={18} height={18} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
