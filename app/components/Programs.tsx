...
const programs = [
  {
    ...
    age: "3 Mos – 2 Yrs",
    summary: "Safe, loving infant care focused on sensory discovery, motor skills, and nurturing daily routines.",
  ...
  },
  {
    ...
    age: "2 – 6 Years",
    summary: "Trilingual immersion in English, French & Kinyarwanda fostering literacy, numeracy, and creativity.",
  ...
  },
  {
    ...
    age: "6 – 13 Years",
    summary: "National REB curriculum excellence fostering academic mastery, digital literacy, and leadership.",
      ...
      <div className="programs-container">
        ...
        <div className="programs-header-new">
          <div className="about-eyebrow">
            ...
            <span className="about-eyebrow-text">ACADEMIC PATHWAY</span>
            <div className="about-eyebrow-icon-wrap">
              <Image
                src="/icon-3.jpeg"
                alt="Imigongo icon"
          ...
          <h2 id="programs-heading" className="about-title" style={{ marginBottom: "0.75rem" }}>
            World-Class Learning for Every Age
          </h2>
            ...
            >
              ...
              <div className="prog-square-content">
                ...
                <div className="prog-square-top">
                  <span className={`prog-square-age prog-square-age--${prog.theme}`}>
                    {prog.age}
                  </span>
                </div>
                ...
                <div className="prog-square-titles">
                  ...
                  <span className={`prog-square-level prog-square-level--${prog.theme}`}>
                    {prog.level}
                  </span>
                </div>
                ...
                <div className="prog-square-points">
                  {prog.points.map((point, idx) => (
                    <div key={idx} className="prog-square-point">
                      <span className={`prog-square-dot prog-square-dot--${prog.theme}`}>
                        <CheckIcon size={10} />
                      </span>
                      <span>{point}</span>
                    </div>
